		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#ejerfioricertificaciones1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ejerfioricertificaciones1-display": {
								"semanticObject": "ejerfioricertificaciones1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ejerfiori.certificaciones1",
									"url": sap.ui.require.toUrl("ejerfiori/certificaciones1")
								}
							}
						}
					}
